...
- [x] 为 handoff 定义 `reason`、`priority`、`expected_output`、`context_refs`
- [x] 调度 Agent handoff 前必须输出结构化 handoff payload
...
- [x] 定义评估样例集：debug、review、research、deploy、monitor
